...
NOTE: Before Pathom 2.2.10 the default functions to work with GraphQL used to convert
...
points started with capital letters. To avoid those problems, since Pathom 2.2.10 we
