...
profiler with this, you remove `pp/profile-plugin` and add the `p/trace-plugin` (better as
...
[source,clojure]
----
include::../src-docs/com/wsscode/pathom/book/core/join_env_update.cljs[]
----
