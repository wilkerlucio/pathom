...
var G__48942 = devtools.prefs.pref(v);
v = G__48942;
continue;
} else {
return v;
...
}catch (e48919){var _e__47514__auto__ = e48919;
return false;
}})();
...
}catch (e48923){var _e__47514__auto__ = e48923;
return false;
}})();
...
}catch (e48925){var _e__47514__auto__ = e48925;
return false;
}}
}
});
...
var vec__48933 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48933,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48933,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__48940_SHARP_);
}),template);
});
