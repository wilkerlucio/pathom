...
var leave_items = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__44936_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("com.wsscode.pathom.trace","leave","com.wsscode.pathom.trace/leave",-499718108),p1__44936_SHARP_);
...
var e = map__44975__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44975__$1,new cljs.core.Keyword("com.wsscode.pathom.trace","id","com.wsscode.pathom.trace/id",-1736155805));
var timestamp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44975__$1,new cljs.core.Keyword("com.wsscode.pathom.trace","timestamp","com.wsscode.pathom.trace/timestamp",1867371402));
...
if(cljs.core.truth_(temp__5718__auto__)){
var map__45019 = temp__5718__auto__;
...
var leave = map__45019__$1;
var et = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45019__$1,new cljs.core.Keyword("com.wsscode.pathom.trace","timestamp","com.wsscode.pathom.trace/timestamp",1867371402));
...
var hierarchy__4617__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__45021 = cljs.core.get_global_hierarchy;
return (fexpr__45021.cljs$core$IFn$_invoke$arity$0 ? fexpr__45021.cljs$core$IFn$_invoke$arity$0() : fexpr__45021.call(null));
})());
...
com.wsscode.pathom.trace.tree_assoc_key_detail = (function com$wsscode$pathom$trace$tree_assoc_key_detail(p__45022,x,keys){
...
var row = map__45023__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45023__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
return new cljs.core.Keyword(null,"response","response",-1068424192).cljs$core$IFn$_invoke$arity$1(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (x,p__45026){
...
var row = map__45027__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45027__$1,new cljs.core.Keyword("com.wsscode.pathom.trace","event","com.wsscode.pathom.trace/event",1287398983));
var relative_timestamp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45027__$1,new cljs.core.Keyword("com.wsscode.pathom.trace","relative-timestamp","com.wsscode.pathom.trace/relative-timestamp",1322755700));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45027__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var G__45029 = event;
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(x,new cljs.core.Keyword(null,"response","response",-1068424192),((function (G__45029,G__45029__$1,map__45027,map__45027__$1,row,event,relative_timestamp,key){
return (function (p1__45025_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.select_keys(row,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("com.wsscode.pathom.trace","duration","com.wsscode.pathom.trace/duration",-1764288295),new cljs.core.Keyword("com.wsscode.pathom.trace","relative-timestamp","com.wsscode.pathom.trace/relative-timestamp",1322755700),new cljs.core.Keyword("com.wsscode.pathom.core","path","com.wsscode.pathom.core/path",-1532419661)], null)),p1__45025_SHARP_], 0));
});})(G__45029,G__45029__$1,map__45027,map__45027__$1,row,event,relative_timestamp,key))
);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (count,G__45029,G__45029__$1,map__45027,map__45027__$1,row,event,relative_timestamp,key){
...
});})(count,G__45029,G__45029__$1,map__45027,map__45027__$1,row,event,relative_timestamp,key))
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (G__45029,G__45029__$1,map__45027,map__45027__$1,row,event,relative_timestamp,key){
...
var res = cljs.core.update.cljs$core$IFn$_invoke$arity$3(x,new cljs.core.Keyword("com.wsscode.pathom.trace","details","com.wsscode.pathom.trace/details",560259810),(function (p1__45030_SHARP_){
return cljs.core.vec(cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("com.wsscode.pathom.trace","relative-timestamp","com.wsscode.pathom.trace/relative-timestamp",1322755700),p1__45030_SHARP_));
}));
...
var x__4219__auto__ = (function (){var or__4131__auto__ = p1__45031_SHARP_;
...
return com.wsscode.pathom.trace.compute_details_duration(G__45032);
} else {
return G__45032;
}
}),trace_tree);
});
com.wsscode.pathom.trace.compute_d3_tree = (function com$wsscode$pathom$trace$compute_d3_tree(p__45033){
...
var relative_timestamp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45034__$1,new cljs.core.Keyword("com.wsscode.pathom.trace","relative-timestamp","com.wsscode.pathom.trace/relative-timestamp",1322755700));
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45034__$1,new cljs.core.Keyword("com.wsscode.pathom.trace","duration","com.wsscode.pathom.trace/duration",-1764288295));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45034__$1,new cljs.core.Keyword("com.wsscode.pathom.trace","children","com.wsscode.pathom.trace/children",1897633555));
var details = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45034__$1,new cljs.core.Keyword("com.wsscode.pathom.trace","details","com.wsscode.pathom.trace/details",560259810));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45034__$1,new cljs.core.Keyword("com.wsscode.pathom.core","path","com.wsscode.pathom.core/path",-1532419661));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45034__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var G__45036 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"start","start",-355208981),relative_timestamp,new cljs.core.Keyword(null,"path","path",-188191168),path,new cljs.core.Keyword(null,"duration","duration",1444101068),(function (){var or__4131__auto__ = duration;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
return (0);
}
})(),new cljs.core.Keyword(null,"details","details",1956795411),cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(((function (map__45034,map__45034__$1,relative_timestamp,duration,children,details,path,key){
...
var row = map__45038__$1;
var relative_timestamp__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45038__$1,new cljs.core.Keyword("com.wsscode.pathom.trace","relative-timestamp","com.wsscode.pathom.trace/relative-timestamp",1322755700));
var duration__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45038__$1,new cljs.core.Keyword("com.wsscode.pathom.trace","duration","com.wsscode.pathom.trace/duration",-1764288295));
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45038__$1,new cljs.core.Keyword("com.wsscode.pathom.trace","event","com.wsscode.pathom.trace/event",1287398983));
var details__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (map__45038,map__45038__$1,row,relative_timestamp__$1,duration__$1,event,map__45034,map__45034__$1,relative_timestamp,duration,children,details,path,key){
return (function (p__45040){
var vec__45041 = p__45040;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45041,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45041,(1),null);
...
});})(map__45038,map__45038__$1,row,relative_timestamp__$1,duration__$1,event,map__45034,map__45034__$1,relative_timestamp,duration,children,details,path,key))
...
});})(map__45034,map__45034__$1,relative_timestamp,duration,children,details,path,key))
,details)], null);
var G__45036__$1 = (cljs.core.truth_(key)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45036,new cljs.core.Keyword(null,"name","name",1843675177),cljs.core.str.cljs$core$IFn$_invoke$arity$1(key)):G__45036);
if(cljs.core.truth_(children)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45036__$1,new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(com.wsscode.pathom.trace.compute_d3_tree,cljs.core.second),children)));
} else {
return G__45036__$1;
}
});
...
var res__44802__auto__ = (parser.cljs$core$IFn$_invoke$arity$2 ? parser.cljs$core$IFn$_invoke$arity$2(env_SINGLEQUOTE_,tx) : parser.call(null,env_SINGLEQUOTE_,tx));
...
cljs.core.async.impl.dispatch.run(((function (c__39003__auto__,res__44802__auto__,trace_STAR_,env_SINGLEQUOTE_,parser_trace){
return (function (){
var f__39004__auto__ = (function (){var switch__38929__auto__ = ((function (c__39003__auto__,res__44802__auto__,trace_STAR_,env_SINGLEQUOTE_,parser_trace){
return (function (state_45065){
var state_val_45066 = (state_45065[(1)]);
if((state_val_45066 === (1))){
var state_45065__$1 = state_45065;
var statearr_45067_45161 = state_45065__$1;
(statearr_45067_45161[(2)] = null);

(statearr_45067_45161[(1)] = (4));
...
var inst_45044 = (state_45065[(2)]);
var state_45065__$1 = state_45065;
var statearr_45068_45162 = state_45065__$1;
(statearr_45068_45162[(2)] = inst_45044);


cljs.core.async.impl.ioc_helpers.process_exception(state_45065__$1);

return new cljs.core.Keyword(null,"recur","recur",-437573268);
} else {
if((state_val_45066 === (4))){
var _ = cljs.core.async.impl.ioc_helpers.add_exception_frame(state_45065,(3),new cljs.core.Keyword(null,"default","default",-1987822328),null,(2));
var state_45065__$1 = state_45065;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_45065__$1,(5),res__44802__auto__);
} else {
if((state_val_45066 === (5))){
var inst_45049 = (state_45065[(2)]);
var inst_45050 = com.wsscode.common.async_cljs.throw_err(inst_45049);
var inst_45051 = [new cljs.core.Keyword("com.wsscode.pathom.trace","event","com.wsscode.pathom.trace/event",1287398983)];
var inst_45052 = [new cljs.core.Keyword("com.wsscode.pathom.trace","trace-plugin","com.wsscode.pathom.trace/trace-plugin",874601792)];
var inst_45053 = cljs.core.PersistentHashMap.fromArrays(inst_45051,inst_45052);
var inst_45054 = com.wsscode.pathom.trace.trace_leave.cljs$core$IFn$_invoke$arity$3(env_SINGLEQUOTE_,parser_trace,inst_45053);
var inst_45055 = [new cljs.core.Keyword("com.wsscode.pathom.trace","event","com.wsscode.pathom.trace/event",1287398983)];
var inst_45056 = [new cljs.core.Keyword("com.wsscode.pathom.trace","trace-done","com.wsscode.pathom.trace/trace-done",-1293580361)];
var inst_45057 = cljs.core.PersistentHashMap.fromArrays(inst_45055,inst_45056);
var inst_45058 = com.wsscode.pathom.trace.trace(env_SINGLEQUOTE_,inst_45057);
var inst_45059 = cljs.core.deref(trace_STAR_);
var inst_45060 = com.wsscode.pathom.trace.trace__GT_viz(inst_45059);
var inst_45061 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(inst_45050,new cljs.core.Keyword("com.wsscode.pathom","trace","com.wsscode.pathom/trace",1253203063),inst_45060);
var state_45065__$1 = (function (){var statearr_45069 = state_45065;
(statearr_45069[(7)] = inst_45054);

(statearr_45069[(8)] = inst_45058);

return statearr_45069;
})();
var statearr_45070_45178 = state_45065__$1;
(statearr_45070_45178[(2)] = inst_45061);
...
});})(c__39003__auto__,res__44802__auto__,trace_STAR_,env_SINGLEQUOTE_,parser_trace))
;
return ((function (switch__38929__auto__,c__39003__auto__,res__44802__auto__,trace_STAR_,env_SINGLEQUOTE_,parser_trace){
return (function() {
var com$wsscode$pathom$trace$wrap_parser_trace_$_wrap_parser_trace_internal_$_state_machine__38930__auto__ = null;
var com$wsscode$pathom$trace$wrap_parser_trace_$_wrap_parser_trace_internal_$_state_machine__38930__auto____0 = (function (){
var statearr_45071 = [null,null,null,null,null,null,null,null,null];
(statearr_45071[(0)] = com$wsscode$pathom$trace$wrap_parser_trace_$_wrap_parser_trace_internal_$_state_machine__38930__auto__);

(statearr_45071[(1)] = (1));

return statearr_45071;
});
var com$wsscode$pathom$trace$wrap_parser_trace_$_wrap_parser_trace_internal_$_state_machine__38930__auto____1 = (function (state_45065){
while(true){
var ret_value__38931__auto__ = (function (){try{while(true){
var result__38932__auto__ = switch__38929__auto__(state_45065);
...
var ex__38933__auto__ = e45072;
var statearr_45073_45182 = state_45065;
(statearr_45073_45182[(5)] = ex__38933__auto__);


cljs.core.async.impl.ioc_helpers.process_exception(state_45065);
...
var G__45185 = state_45065;
state_45065 = G__45185;
continue;
} else {
...
com$wsscode$pathom$trace$wrap_parser_trace_$_wrap_parser_trace_internal_$_state_machine__38930__auto__ = function(state_45065){
switch(arguments.length){
case 0:
return com$wsscode$pathom$trace$wrap_parser_trace_$_wrap_parser_trace_internal_$_state_machine__38930__auto____0.call(this);
case 1:
return com$wsscode$pathom$trace$wrap_parser_trace_$_wrap_parser_trace_internal_$_state_machine__38930__auto____1.call(this,state_45065);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
com$wsscode$pathom$trace$wrap_parser_trace_$_wrap_parser_trace_internal_$_state_machine__38930__auto__.cljs$core$IFn$_invoke$arity$0 = com$wsscode$pathom$trace$wrap_parser_trace_$_wrap_parser_trace_internal_$_state_machine__38930__auto____0;
com$wsscode$pathom$trace$wrap_parser_trace_$_wrap_parser_trace_internal_$_state_machine__38930__auto__.cljs$core$IFn$_invoke$arity$1 = com$wsscode$pathom$trace$wrap_parser_trace_$_wrap_parser_trace_internal_$_state_machine__38930__auto____1;
return com$wsscode$pathom$trace$wrap_parser_trace_$_wrap_parser_trace_internal_$_state_machine__38930__auto__;
})()
;})(switch__38929__auto__,c__39003__auto__,res__44802__auto__,trace_STAR_,env_SINGLEQUOTE_,parser_trace))
})();
var state__39005__auto__ = (function (){var statearr_45074 = (f__39004__auto__.cljs$core$IFn$_invoke$arity$0 ? f__39004__auto__.cljs$core$IFn$_invoke$arity$0() : f__39004__auto__.call(null));
(statearr_45074[(6)] = c__39003__auto__);
