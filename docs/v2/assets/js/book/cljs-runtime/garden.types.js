...
garden.types.CSSUnit.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k46294,else__4388__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k46294,else__4388__auto__);
...
return (function (ret__4407__auto__,p__46318){
var vec__46320 = p__46318;
var k__4408__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46320,(0),null);
var v__4409__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46320,(1),null);
...
garden.types.CSSUnit.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__46293){
var self__ = this;
var G__46293__$1 = this;
return (new cljs.core.RecordIter((0),G__46293__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"unit","unit",375175175),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
garden.types.CSSUnit.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this46295,other46296){
var self__ = this;
var this46295__$1 = this;
return (((!((other46296 == null)))) && ((this46295__$1.constructor === other46296.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46295__$1.unit,other46296.unit)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46295__$1.magnitude,other46296.magnitude)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46295__$1.__extmap,other46296.__extmap)));
});
...
garden.types.CSSUnit.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__46293){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__46336 = cljs.core.keyword_identical_QMARK_;
var expr__46337 = k__4393__auto__;
if(cljs.core.truth_((pred__46336.cljs$core$IFn$_invoke$arity$2 ? pred__46336.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"unit","unit",375175175),expr__46337) : pred__46336.call(null,new cljs.core.Keyword(null,"unit","unit",375175175),expr__46337)))){
return (new garden.types.CSSUnit(G__46293,self__.magnitude,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46336.cljs$core$IFn$_invoke$arity$2 ? pred__46336.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"magnitude","magnitude",1924274222),expr__46337) : pred__46336.call(null,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222),expr__46337)))){
return (new garden.types.CSSUnit(self__.unit,G__46293,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSUnit(self__.unit,self__.magnitude,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4393__auto__,G__46293),null));
}
}
});
...
garden.types.CSSUnit.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__46293){
var self__ = this;
var this__4384__auto____$1 = this;
return (new garden.types.CSSUnit(self__.unit,self__.magnitude,G__46293,self__.__extmap,self__.__hash));
});
 ...
 */
garden.types.map__GT_CSSUnit = (function garden$types$map__GT_CSSUnit(G__46302){
var extmap__4424__auto__ = (function (){var G__46346 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__46302,new cljs.core.Keyword(null,"unit","unit",375175175),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"magnitude","magnitude",1924274222)], 0));
...
return (new garden.types.CSSUnit(new cljs.core.Keyword(null,"unit","unit",375175175).cljs$core$IFn$_invoke$arity$1(G__46302),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222).cljs$core$IFn$_invoke$arity$1(G__46302),null,cljs.core.not_empty(extmap__4424__auto__),null));
});
...
garden.types.CSSFunction.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k46350,else__4388__auto__){
var self__ = this;
var this__4387__auto____$1 = this;
var G__46358 = k46350;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k46350,else__4388__auto__);
...
var this__4404__auto____$1 = this;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (this__4404__auto____$1){
return (function (ret__4407__auto__,p__46360){
var vec__46361 = p__46360;
var k__4408__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46361,(0),null);
var v__4409__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46361,(1),null);
return (f__4405__auto__.cljs$core$IFn$_invoke$arity$3 ? f__4405__auto__.cljs$core$IFn$_invoke$arity$3(ret__4407__auto__,k__4408__auto__,v__4409__auto__) : f__4405__auto__.call(null,ret__4407__auto__,k__4408__auto__,v__4409__auto__));
});})(this__4404__auto____$1))
,init__4406__auto__,this__4404__auto____$1);
});
...
garden.types.CSSFunction.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__46349){
var self__ = this;
var G__46349__$1 = this;
return (new cljs.core.RecordIter((0),G__46349__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"args","args",1315556576)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
garden.types.CSSFunction.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this46351,other46352){
var self__ = this;
var this46351__$1 = this;
return (((!((other46352 == null)))) && ((this46351__$1.constructor === other46352.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46351__$1.f,other46352.f)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46351__$1.args,other46352.args)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46351__$1.__extmap,other46352.__extmap)));
});
...
garden.types.CSSFunction.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__46349){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__46404 = cljs.core.keyword_identical_QMARK_;
var expr__46405 = k__4393__auto__;
if(cljs.core.truth_((pred__46404.cljs$core$IFn$_invoke$arity$2 ? pred__46404.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),expr__46405) : pred__46404.call(null,new cljs.core.Keyword(null,"f","f",-1597136552),expr__46405)))){
return (new garden.types.CSSFunction(G__46349,self__.args,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46404.cljs$core$IFn$_invoke$arity$2 ? pred__46404.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"args","args",1315556576),expr__46405) : pred__46404.call(null,new cljs.core.Keyword(null,"args","args",1315556576),expr__46405)))){
return (new garden.types.CSSFunction(self__.f,G__46349,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSFunction(self__.f,self__.args,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4393__auto__,G__46349),null));
}
}
});
...
garden.types.CSSFunction.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__46349){
var self__ = this;
var this__4384__auto____$1 = this;
return (new garden.types.CSSFunction(self__.f,self__.args,G__46349,self__.__extmap,self__.__hash));
});
 ...
 */
garden.types.map__GT_CSSFunction = (function garden$types$map__GT_CSSFunction(G__46354){
var extmap__4424__auto__ = (function (){var G__46418 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__46354,new cljs.core.Keyword(null,"f","f",-1597136552),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"args","args",1315556576)], 0));
if(cljs.core.record_QMARK_(G__46354)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46418);
} else {
return G__46418;
}
})();
return (new garden.types.CSSFunction(new cljs.core.Keyword(null,"f","f",-1597136552).cljs$core$IFn$_invoke$arity$1(G__46354),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(G__46354),null,cljs.core.not_empty(extmap__4424__auto__),null));
});
...
garden.types.CSSAtRule.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k46423,else__4388__auto__){
var self__ = this;
var this__4387__auto____$1 = this;
var G__46455 = k46423;
var G__46455__$1 = (((G__46455 instanceof cljs.core.Keyword))?G__46455.fqn:null);
switch (G__46455__$1) {
case "identifier":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k46423,else__4388__auto__);
...
var this__4404__auto____$1 = this;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (this__4404__auto____$1){
return (function (ret__4407__auto__,p__46459){
var vec__46461 = p__46459;
var k__4408__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46461,(0),null);
var v__4409__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46461,(1),null);
return (f__4405__auto__.cljs$core$IFn$_invoke$arity$3 ? f__4405__auto__.cljs$core$IFn$_invoke$arity$3(ret__4407__auto__,k__4408__auto__,v__4409__auto__) : f__4405__auto__.call(null,ret__4407__auto__,k__4408__auto__,v__4409__auto__));
});})(this__4404__auto____$1))
,init__4406__auto__,this__4404__auto____$1);
});
...
garden.types.CSSAtRule.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__46422){
var self__ = this;
var G__46422__$1 = this;
return (new cljs.core.RecordIter((0),G__46422__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"identifier","identifier",-805503498),new cljs.core.Keyword(null,"value","value",305978217)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
garden.types.CSSAtRule.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this46425,other46426){
var self__ = this;
var this46425__$1 = this;
return (((!((other46426 == null)))) && ((this46425__$1.constructor === other46426.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46425__$1.identifier,other46426.identifier)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46425__$1.value,other46426.value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46425__$1.__extmap,other46426.__extmap)));
});
...
garden.types.CSSAtRule.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__46422){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__46487 = cljs.core.keyword_identical_QMARK_;
var expr__46488 = k__4393__auto__;
if(cljs.core.truth_((pred__46487.cljs$core$IFn$_invoke$arity$2 ? pred__46487.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"identifier","identifier",-805503498),expr__46488) : pred__46487.call(null,new cljs.core.Keyword(null,"identifier","identifier",-805503498),expr__46488)))){
return (new garden.types.CSSAtRule(G__46422,self__.value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__46487.cljs$core$IFn$_invoke$arity$2 ? pred__46487.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__46488) : pred__46487.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__46488)))){
return (new garden.types.CSSAtRule(self__.identifier,G__46422,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSAtRule(self__.identifier,self__.value,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4393__auto__,G__46422),null));
}
}
});
...
garden.types.CSSAtRule.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__46422){
var self__ = this;
var this__4384__auto____$1 = this;
return (new garden.types.CSSAtRule(self__.identifier,self__.value,G__46422,self__.__extmap,self__.__hash));
});
 ...
 */
garden.types.map__GT_CSSAtRule = (function garden$types$map__GT_CSSAtRule(G__46434){
var extmap__4424__auto__ = (function (){var G__46501 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__46434,new cljs.core.Keyword(null,"identifier","identifier",-805503498),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"value","value",305978217)], 0));
if(cljs.core.record_QMARK_(G__46434)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46501);
} else {
return G__46501;
}
})();
return (new garden.types.CSSAtRule(new cljs.core.Keyword(null,"identifier","identifier",-805503498).cljs$core$IFn$_invoke$arity$1(G__46434),new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__46434),null,cljs.core.not_empty(extmap__4424__auto__),null));
});
