 ...
 *   ```
 */
com.wsscode.fuzzy.match_one = (function com$wsscode$fuzzy$match_one(p__84035,p__84036){
var map__84038 = p__84035;
var map__84038__$1 = (((((!((map__84038 == null))))?(((((map__84038.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__84038.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__84038):map__84038);
var search_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__84038__$1,new cljs.core.Keyword("com.wsscode.fuzzy","search-input","com.wsscode.fuzzy/search-input",897823168));
var map__84039 = p__84036;
var map__84039__$1 = (((((!((map__84039 == null))))?(((((map__84039.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__84039.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__84039):map__84039);
var opt = map__84039__$1;
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__84039__$1,new cljs.core.Keyword("com.wsscode.fuzzy","string","com.wsscode.fuzzy/string",320074815));
var vec__84068 = com.wsscode.fuzzyjs.fuzzy_match(search_input,string);
var match_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__84068,(0),null);
var score = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__84068,(1),null);
var hl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__84068,(2),null);
 ...
 */
com.wsscode.fuzzy.fuzzy_match = (function com$wsscode$fuzzy$fuzzy_match(p__84083){
var map__84084 = p__84083;
var map__84084__$1 = (((((!((map__84084 == null))))?(((((map__84084.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__84084.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__84084):map__84084);
var input = map__84084__$1;
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__84084__$1,new cljs.core.Keyword("com.wsscode.fuzzy","options","com.wsscode.fuzzy/options",773495630));
var search_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__84084__$1,new cljs.core.Keyword("com.wsscode.fuzzy","search-input","com.wsscode.fuzzy/search-input",897823168));
var sort_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__84084__$1,new cljs.core.Keyword("com.wsscode.fuzzy","sort?","com.wsscode.fuzzy/sort?",1163052809),true);
if(cljs.core.seq(search_input)){
var fuzzy = cljs.core.partial.cljs$core$IFn$_invoke$arity$2(com.wsscode.fuzzy.match_one,input);
var compare = ((function (fuzzy,map__84084,map__84084__$1,input,options,search_input,sort_QMARK_){
return (function (p1__84076_SHARP_,p2__84075_SHARP_){
return cljs.core.compare(p2__84075_SHARP_,p1__84076_SHARP_);
});})(fuzzy,map__84084,map__84084__$1,input,options,search_input,sort_QMARK_))
;
var _LT__GT_ = options;
var _LT__GT___$1 = cljs.core.keep.cljs$core$IFn$_invoke$arity$2(fuzzy,_LT__GT_);
var G__84094 = _LT__GT___$1;
if(cljs.core.truth_(sort_QMARK_)){
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("com.wsscode.fuzzy","match-score","com.wsscode.fuzzy/match-score",-1700262252),compare,G__84094);
} else {
return G__84094;
}
} else {
