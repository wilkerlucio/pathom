...
com.wsscode.pathom.book.connect.batch.list_things = com.wsscode.pathom.connect.resolver(new cljs.core.Symbol("com.wsscode.pathom.book.connect.batch","list-things","com.wsscode.pathom.book.connect.batch/list-things",-114820299,null),(function (){var G__60906 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("com.wsscode.pathom.connect","output","com.wsscode.pathom.connect/output",552487303),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"items","items",1031954938),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"number","number",1570378438)], null)], null)], null)], null);
return G__60906;
...
com.wsscode.pathom.book.connect.batch.slow_resolver = com.wsscode.pathom.connect.resolver(new cljs.core.Symbol("com.wsscode.pathom.book.connect.batch","slow-resolver","com.wsscode.pathom.book.connect.batch/slow-resolver",555020778,null),(function (){var G__60929 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("com.wsscode.pathom.connect","input","com.wsscode.pathom.connect/input",-1274439121),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"number","number",1570378438),null], null), null),new cljs.core.Keyword("com.wsscode.pathom.connect","output","com.wsscode.pathom.connect/output",552487303),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"number-added","number-added",1161719489)], null)], null);
return G__60929;

})(),(function com$wsscode$pathom$book$connect$batch$slow_resolver(_,p__60940){
var map__60944 = p__60940;
...
var number = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60944__$1,new cljs.core.Keyword(null,"number","number",1570378438));
var c__47946__auto__ = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
cljs.core.async.impl.dispatch.run(((function (c__47946__auto__,map__60944,map__60944__$1,number){
return (function (){
var f__47947__auto__ = (function (){var switch__47663__auto__ = ((function (c__47946__auto__,map__60944,map__60944__$1,number){
return (function (state_60981){
var state_val_60983 = (state_60981[(1)]);
if((state_val_60983 === (1))){
var inst_60965 = cljs.core.async.timeout((1000));
var state_60981__$1 = state_60981;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_60981__$1,(2),inst_60965);
} else {
if((state_val_60983 === (2))){
var inst_60968 = (state_60981[(2)]);
var inst_60969 = [new cljs.core.Keyword(null,"number-added","number-added",1161719489)];
var inst_60975 = (number + (1));
var inst_60976 = [inst_60975];
var inst_60977 = cljs.core.PersistentHashMap.fromArrays(inst_60969,inst_60976);
var state_60981__$1 = (function (){var statearr_61028 = state_60981;
(statearr_61028[(7)] = inst_60968);

return statearr_61028;
})();
return cljs.core.async.impl.ioc_helpers.return_chan(state_60981__$1,inst_60977);
} else {
return null;
}
}
});})(c__47946__auto__,map__60944,map__60944__$1,number))
;
return ((function (switch__47663__auto__,c__47946__auto__,map__60944,map__60944__$1,number){
return (function() {
...
var statearr_61062 = [null,null,null,null,null,null,null,null];
(statearr_61062[(0)] = com$wsscode$pathom$book$connect$batch$slow_resolver_$_state_machine__47664__auto__);

(statearr_61062[(1)] = (1));

return statearr_61062;
});
var com$wsscode$pathom$book$connect$batch$slow_resolver_$_state_machine__47664__auto____1 = (function (state_60981){
while(true){
var ret_value__47665__auto__ = (function (){try{while(true){
var result__47666__auto__ = switch__47663__auto__(state_60981);
...
}catch (e61071){if((e61071 instanceof Object)){
var ex__47667__auto__ = e61071;
var statearr_61073_61160 = state_60981;
(statearr_61073_61160[(5)] = ex__47667__auto__);


cljs.core.async.impl.ioc_helpers.process_exception(state_60981);
...
var G__61162 = state_60981;
state_60981 = G__61162;
continue;
} else {
...
com$wsscode$pathom$book$connect$batch$slow_resolver_$_state_machine__47664__auto__ = function(state_60981){
switch(arguments.length){
case 0:
return com$wsscode$pathom$book$connect$batch$slow_resolver_$_state_machine__47664__auto____0.call(this);
case 1:
return com$wsscode$pathom$book$connect$batch$slow_resolver_$_state_machine__47664__auto____1.call(this,state_60981);
}
...
;})(switch__47663__auto__,c__47946__auto__,map__60944,map__60944__$1,number))
})();
var state__47948__auto__ = (function (){var statearr_61100 = f__47947__auto__();
(statearr_61100[(6)] = c__47946__auto__);
