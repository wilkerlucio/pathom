...
var _STAR_config_cache_74575 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("ghostwheel.utils","timestamp","ghostwheel.utils/timestamp",-1150458516),(0),new cljs.core.Keyword("ghostwheel.utils","value","ghostwheel.utils/value",2111420378),null], null));
var read_config_file_74576 = ((function (_STAR_config_cache_74575){
return (function (){
return null;
});})(_STAR_config_cache_74575))
;
var reload_config_74577 = ((function (_STAR_config_cache_74575,read_config_file_74576){
return (function (){
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.PersistentArrayMap.EMPTY,read_config_file_74576(),cljs_compiler_config], 0));
} else {
return null;
}
})();
if(cljs.core.truth_(plain_config)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (plain_config,_STAR_config_cache_74575,read_config_file_74576){
return (function (p__74538){
var vec__74539 = p__74538;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74539,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__74539,(1),null);
...
});})(plain_config,_STAR_config_cache_74575,read_config_file_74576))
,plain_config));
} else {
return null;
}
});})(_STAR_config_cache_74575,read_config_file_74576))
;
ghostwheel.utils.get_env_config = ((function (_STAR_config_cache_74575,read_config_file_74576,reload_config_74577){
return (function ghostwheel$utils$get_env_config(var_args){
var G__74543 = arguments.length;
switch (G__74543) {
case 0:
...
});})(_STAR_config_cache_74575,read_config_file_74576,reload_config_74577))
;

ghostwheel.utils.get_env_config.cljs$core$IFn$_invoke$arity$0 = ((function (_STAR_config_cache_74575,read_config_file_74576,reload_config_74577){
return (function (){
return ghostwheel.utils.get_env_config.cljs$core$IFn$_invoke$arity$1(true);
});})(_STAR_config_cache_74575,read_config_file_74576,reload_config_74577))
;

ghostwheel.utils.get_env_config.cljs$core$IFn$_invoke$arity$1 = ((function (_STAR_config_cache_74575,read_config_file_74576,reload_config_74577){
return (function (cache_QMARK_){
if(cljs.core.not(cache_QMARK_)){
return reload_config_74577();
} else {
var now = cljs.core.identity(Date.now());
if(((now - new cljs.core.Keyword("ghostwheel.utils","timestamp","ghostwheel.utils/timestamp",-1150458516).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(_STAR_config_cache_74575))) < (2000))){
return new cljs.core.Keyword("ghostwheel.utils","value","ghostwheel.utils/value",2111420378).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(_STAR_config_cache_74575));
} else {
return new cljs.core.Keyword("ghostwheel.utils","value","ghostwheel.utils/value",2111420378).cljs$core$IFn$_invoke$arity$1(cljs.core.reset_BANG_(_STAR_config_cache_74575,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("ghostwheel.utils","timestamp","ghostwheel.utils/timestamp",-1150458516),now,new cljs.core.Keyword("ghostwheel.utils","value","ghostwheel.utils/value",2111420378),reload_config_74577()], null)));
}
}
});})(_STAR_config_cache_74575,read_config_file_74576,reload_config_74577))
;
...
var ns_replacements = (function (){var G__74570 = new cljs.core.PersistentArrayMap(null, 6, ["clojure.core","cljs.core","clojure.test","cljs.test","clojure.spec.alpha","cljs.spec.alpha","clojure.spec.test.alpha","cljs.spec.test.alpha","orchestra.spec.test","orchestra-cljs.spec.test","clojure.spec.gen.alpha","cljs.spec.gen.alpha"], null);
if(cljs.core.truth_(strip_core_ns)){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__74570,new cljs.core.PersistentArrayMap(null, 2, ["clojure.core",null,"cljs.core",null], null)], 0));
} else {
return G__74570;
}
})();
var replace_namespace = ((function (ns_replacements){
return (function (p1__74557_SHARP_){
if((!(cljs.core.qualified_symbol_QMARK_(p1__74557_SHARP_)))){
return p1__74557_SHARP_;
} else {
var nspace = cljs.core.namespace(p1__74557_SHARP_);
if(cljs.core.contains_QMARK_(ns_replacements,nspace)){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.get.cljs$core$IFn$_invoke$arity$2(ns_replacements,nspace),cljs.core.name(p1__74557_SHARP_));
} else {
return p1__74557_SHARP_;
}
}
