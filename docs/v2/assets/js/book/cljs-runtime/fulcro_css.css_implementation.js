...
var vec__56056 = cljs.core.re_matches(/(\.|\$|&\.|&\$).*/,nm);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56056,(0),null);
var prefix = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56056,(1),null);
return prefix;
});
/**
...
return (function (p1__56086_SHARP_,p2__56087_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(p1__56086_SHARP_,(fulcro_css.css_implementation.get_nested_includes.cljs$core$IFn$_invoke$arity$1 ? fulcro_css.css_implementation.get_nested_includes.cljs$core$IFn$_invoke$arity$1(p2__56087_SHARP_) : fulcro_css.css_implementation.get_nested_includes.call(null,p2__56087_SHARP_)));
});})(direct_children))
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56099)].join('')));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56122)].join('')));
...
return cljs.core.re_matches(/[.$].*/,p1__56133_SHARP_);
});})(val))
...
return fulcro_css.css_implementation.kw__GT_localized_classname(comp,p1__56155_SHARP_);
