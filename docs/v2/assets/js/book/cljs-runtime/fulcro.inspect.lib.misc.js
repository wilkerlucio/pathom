...
var db_SINGLEQUOTE_ = map__52029__$1;
var history = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52029__$1,new cljs.core.Keyword("fulcro.inspect.lib.misc","history","fulcro.inspect.lib.misc/history",1140630734));
if((cljs.core.count(history) > size)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(db_SINGLEQUOTE_,cljs.core.first(history)),new cljs.core.Keyword("fulcro.inspect.lib.misc","history","fulcro.inspect.lib.misc/history",1140630734),((function (map__52029,map__52029__$1,db_SINGLEQUOTE_,history){
return (function (p1__52028_SHARP_){
return cljs.core.vec(cljs.core.next(p1__52028_SHARP_));
});})(map__52029,map__52029__$1,db_SINGLEQUOTE_,history))
);
} else {
