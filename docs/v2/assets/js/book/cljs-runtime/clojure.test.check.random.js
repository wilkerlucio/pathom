...
var G__62509 = z;
if(((24) > (function (){var G__62513 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__62513) : clojure.test.check.random.longs.bit_count.call(null,G__62513));
})())){
return clojure.test.check.random.longs.bit_xor(G__62509,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__62509;
}
});
...
var G__62612 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__62613 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__62612;
ret = G__62613;
continue;
}
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62546__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__62550 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62550,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62550,(1),null);
