...
var G__69882 = z;
if(((24) > (function (){var G__69884 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__69884) : clojure.test.check.random.longs.bit_count.call(null,G__69884));
})())){
return clojure.test.check.random.longs.bit_xor(G__69882,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__69882;
}
});
...
var G__69966 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__69967 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__69966;
ret = G__69967;
continue;
}
...
return (function (p__69922){
var map__69923 = p__69922;
var map__69923__$1 = (((((!((map__69923 == null))))?(((((map__69923.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__69923.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__69923):map__69923);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69923__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__69926 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69926,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69926,(1),null);
