...
com.wsscode.pathom.map_db.map_db_ident_reader = (function com$wsscode$pathom$map_db$map_db_ident_reader(p__59188){
...
var env = map__59190__$1;
var ast = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59190__$1,new cljs.core.Keyword(null,"ast","ast",-860334068));
var refs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59190__$1,new cljs.core.Keyword("com.wsscode.pathom.map-db","refs","com.wsscode.pathom.map-db/refs",1197152641));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59190__$1,new cljs.core.Keyword("com.wsscode.pathom.core","path","com.wsscode.pathom.core/path",-1532419661));
...
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59225,(1),null);
...
return com.wsscode.pathom.core.join.cljs$core$IFn$_invoke$arity$2(res,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(env,new cljs.core.Keyword("com.wsscode.pathom.core","union-path","com.wsscode.pathom.core/union-path",-2083478095),((function (res,temp__5720__auto__,vec__59225,_,v,path_SINGLEQUOTE_,k,map__59190,map__59190__$1,env,ast,refs,path){
...
var path__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59237__$1,new cljs.core.Keyword("com.wsscode.pathom.core","path","com.wsscode.pathom.core/path",-1532419661));
...
});})(res,temp__5720__auto__,vec__59225,_,v,path_SINGLEQUOTE_,k,map__59190,map__59190__$1,env,ast,refs,path))
));
} else {
return null;
}
...
com.wsscode.pathom.map_db.map_db_reader = (function com$wsscode$pathom$map_db$map_db_reader(p__59252){
...
var env = map__59255__$1;
var ast = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59255__$1,new cljs.core.Keyword(null,"ast","ast",-860334068));
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59255__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var refs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59255__$1,new cljs.core.Keyword("com.wsscode.pathom.map-db","refs","com.wsscode.pathom.map-db/refs",1197152641));
var ident_track = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59255__$1,new cljs.core.Keyword("com.wsscode.pathom.map-db","ident-track","com.wsscode.pathom.map-db/ident-track",1923222506));
...
var vec__59273 = temp__5718__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59273,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59273,(1),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$3(((function (vec__59273,_,v,temp__5718__auto__,entity,map__59255,map__59255__$1,env,ast,query,refs,ident_track){
return (function (p1__59245_SHARP_,p2__59247_SHARP_){
if(com.wsscode.pathom.core.ident_QMARK_(p1__59245_SHARP_)){
if(cljs.core.contains_QMARK_(ident_track,p1__59245_SHARP_)){
return p1__59245_SHARP_;
} else {
return com.wsscode.pathom.core.join.cljs$core$IFn$_invoke$arity$2(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(refs,p1__59245_SHARP_),cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(env,new cljs.core.Keyword("com.wsscode.pathom.map-db","ident-track","com.wsscode.pathom.map-db/ident-track",1923222506),cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__4131__auto__ = ident_track;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
return cljs.core.PersistentHashSet.EMPTY;
}
})(),v),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("com.wsscode.pathom.core","union-path","com.wsscode.pathom.core/union-path",-2083478095),cljs.core.constantly(cljs.core.first(p1__59245_SHARP_))], 0)),new cljs.core.Keyword("com.wsscode.pathom.core","path","com.wsscode.pathom.core/path",-1532419661),cljs.core.conj,p2__59247_SHARP_));
}
} else {
return com.wsscode.pathom.core.join.cljs$core$IFn$_invoke$arity$2(p1__59245_SHARP_,env);
}
});})(vec__59273,_,v,temp__5718__auto__,entity,map__59255,map__59255__$1,env,ast,query,refs,ident_track))
...
var vec__59396 = c;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59396,(0),null);
var sort__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59396,(1),null);
return cljs.core.vec((function (){var G__59401 = type;
var G__59401__$1 = (((G__59401 instanceof cljs.core.Keyword))?G__59401.fqn:null);
switch (G__59401__$1) {
case "single":
...
break;
case "directed":
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(sort__$1),(function (){var G__59405 = new cljs.core.Keyword(null,"direction","direction",-633359395).cljs$core$IFn$_invoke$arity$1(sort__$1);
return (com.wsscode.pathom.map_db.direction_compare.cljs$core$IFn$_invoke$arity$1 ? com.wsscode.pathom.map_db.direction_compare.cljs$core$IFn$_invoke$arity$1(G__59405) : com.wsscode.pathom.map_db.direction_compare.call(null,G__59405));
})(),items);

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__59401__$1)].join('')));
...
var G__59419 = (reader.cljs$core$IFn$_invoke$arity$1 ? reader.cljs$core$IFn$_invoke$arity$1(env) : reader.call(null,env));
if(cljs.core.truth_(sort)){
return com.wsscode.pathom.map_db.sort_results(sort,G__59419);
} else {
return G__59419;
}
});
