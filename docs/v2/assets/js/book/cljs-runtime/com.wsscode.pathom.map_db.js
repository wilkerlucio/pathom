...
com.wsscode.pathom.map_db.map_db_ident_reader = (function com$wsscode$pathom$map_db$map_db_ident_reader(p__68109){
var map__68112 = p__68109;
...
var env = map__68112__$1;
var ast = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68112__$1,new cljs.core.Keyword(null,"ast","ast",-860334068));
var refs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68112__$1,new cljs.core.Keyword("com.wsscode.pathom.map-db","refs","com.wsscode.pathom.map-db/refs",1197152641));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68112__$1,new cljs.core.Keyword("com.wsscode.pathom.core","path","com.wsscode.pathom.core/path",-1532419661));
...
var vec__68121 = k;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68121,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68121,(1),null);
...
return com.wsscode.pathom.core.join.cljs$core$IFn$_invoke$arity$2(res,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(env,new cljs.core.Keyword("com.wsscode.pathom.core","union-path","com.wsscode.pathom.core/union-path",-2083478095),((function (res,temp__5720__auto__,vec__68121,_,v,path_SINGLEQUOTE_,k,map__68112,map__68112__$1,env,ast,refs,path){
return (function (p__68134){
...
var path__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68135__$1,new cljs.core.Keyword("com.wsscode.pathom.core","path","com.wsscode.pathom.core/path",-1532419661));
...
});})(res,temp__5720__auto__,vec__68121,_,v,path_SINGLEQUOTE_,k,map__68112,map__68112__$1,env,ast,refs,path))
));
} else {
return null;
}
...
com.wsscode.pathom.map_db.map_db_reader = (function com$wsscode$pathom$map_db$map_db_reader(p__68167){
...
var env = map__68168__$1;
var ast = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68168__$1,new cljs.core.Keyword(null,"ast","ast",-860334068));
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68168__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var refs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68168__$1,new cljs.core.Keyword("com.wsscode.pathom.map-db","refs","com.wsscode.pathom.map-db/refs",1197152641));
var ident_track = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68168__$1,new cljs.core.Keyword("com.wsscode.pathom.map-db","ident-track","com.wsscode.pathom.map-db/ident-track",1923222506));
...
var vec__68177 = temp__5718__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68177,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68177,(1),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$3(((function (vec__68177,_,v,temp__5718__auto__,entity,map__68168,map__68168__$1,env,ast,query,refs,ident_track){
return (function (p1__68146_SHARP_,p2__68153_SHARP_){
if(com.wsscode.pathom.core.ident_QMARK_(p1__68146_SHARP_)){
if(cljs.core.contains_QMARK_(ident_track,p1__68146_SHARP_)){
return p1__68146_SHARP_;
} else {
return com.wsscode.pathom.core.join.cljs$core$IFn$_invoke$arity$2(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(refs,p1__68146_SHARP_),cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(env,new cljs.core.Keyword("com.wsscode.pathom.map-db","ident-track","com.wsscode.pathom.map-db/ident-track",1923222506),cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__4131__auto__ = ident_track;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
return cljs.core.PersistentHashSet.EMPTY;
}
})(),v),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("com.wsscode.pathom.core","union-path","com.wsscode.pathom.core/union-path",-2083478095),cljs.core.constantly(cljs.core.first(p1__68146_SHARP_))], 0)),new cljs.core.Keyword("com.wsscode.pathom.core","path","com.wsscode.pathom.core/path",-1532419661),cljs.core.conj,p2__68153_SHARP_));
}
} else {
return com.wsscode.pathom.core.join.cljs$core$IFn$_invoke$arity$2(p1__68146_SHARP_,env);
}
});})(vec__68177,_,v,temp__5718__auto__,entity,map__68168,map__68168__$1,env,ast,query,refs,ident_track))
...
var vec__68240 = c;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68240,(0),null);
var sort__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68240,(1),null);
return cljs.core.vec((function (){var G__68244 = type;
...
break;
case "directed":
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(sort__$1),(function (){var G__68266 = new cljs.core.Keyword(null,"direction","direction",-633359395).cljs$core$IFn$_invoke$arity$1(sort__$1);
return (com.wsscode.pathom.map_db.direction_compare.cljs$core$IFn$_invoke$arity$1 ? com.wsscode.pathom.map_db.direction_compare.cljs$core$IFn$_invoke$arity$1(G__68266) : com.wsscode.pathom.map_db.direction_compare.call(null,G__68266));
})(),items);
...
var G__68303 = (reader.cljs$core$IFn$_invoke$arity$1 ? reader.cljs$core$IFn$_invoke$arity$1(env) : reader.call(null,env));
if(cljs.core.truth_(sort)){
return com.wsscode.pathom.map_db.sort_results(sort,G__68303);
} else {
return G__68303;
}
});
...
var env = map__68308__$1;
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68308__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var env_SINGLEQUOTE_ = (function (){var G__68315 = env;
if(cljs.core.truth_(state)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__68315,new cljs.core.Keyword("com.wsscode.pathom.core","entity","com.wsscode.pathom.core/entity",884706031),cljs.core.deref(state),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("com.wsscode.pathom.map-db","refs","com.wsscode.pathom.map-db/refs",1197152641),cljs.core.deref(state)], 0));
} else {
return G__68315;
}
})();
