...
com.wsscode.pathom.map_db.map_db_ident_reader = (function com$wsscode$pathom$map_db$map_db_ident_reader(p__48881){
var map__48883 = p__48881;
...
var env = map__48883__$1;
var ast = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48883__$1,new cljs.core.Keyword(null,"ast","ast",-860334068));
var refs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48883__$1,new cljs.core.Keyword("com.wsscode.pathom.map-db","refs","com.wsscode.pathom.map-db/refs",1197152641));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48883__$1,new cljs.core.Keyword("com.wsscode.pathom.core","path","com.wsscode.pathom.core/path",-1532419661));
...
var vec__48897 = k;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48897,(0),null);
...
return com.wsscode.pathom.core.join.cljs$core$IFn$_invoke$arity$2(res,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(env,new cljs.core.Keyword("com.wsscode.pathom.core","union-path","com.wsscode.pathom.core/union-path",-2083478095),((function (res,temp__5720__auto__,vec__48897,_,v,path_SINGLEQUOTE_,k,map__48883,map__48883__$1,env,ast,refs,path){
return (function (p__48921){
var map__48922 = p__48921;
var map__48922__$1 = (((((!((map__48922 == null))))?(((((map__48922.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48922.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__48922):map__48922);
var path__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48922__$1,new cljs.core.Keyword("com.wsscode.pathom.core","path","com.wsscode.pathom.core/path",-1532419661));
...
});})(res,temp__5720__auto__,vec__48897,_,v,path_SINGLEQUOTE_,k,map__48883,map__48883__$1,env,ast,refs,path))
));
} else {
return null;
}
...
com.wsscode.pathom.map_db.map_db_reader = (function com$wsscode$pathom$map_db$map_db_reader(p__48939){
...
var env = map__48940__$1;
var ast = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48940__$1,new cljs.core.Keyword(null,"ast","ast",-860334068));
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48940__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var refs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48940__$1,new cljs.core.Keyword("com.wsscode.pathom.map-db","refs","com.wsscode.pathom.map-db/refs",1197152641));
var ident_track = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48940__$1,new cljs.core.Keyword("com.wsscode.pathom.map-db","ident-track","com.wsscode.pathom.map-db/ident-track",1923222506));
...
var vec__48948 = temp__5718__auto__;
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$3(((function (vec__48948,_,v,temp__5718__auto__,entity,map__48940,map__48940__$1,env,ast,query,refs,ident_track){
return (function (p1__48930_SHARP_,p2__48934_SHARP_){
if(com.wsscode.pathom.core.ident_QMARK_(p1__48930_SHARP_)){
if(cljs.core.contains_QMARK_(ident_track,p1__48930_SHARP_)){
return p1__48930_SHARP_;
} else {
return com.wsscode.pathom.core.join.cljs$core$IFn$_invoke$arity$2(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(refs,p1__48930_SHARP_),cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(env,new cljs.core.Keyword("com.wsscode.pathom.map-db","ident-track","com.wsscode.pathom.map-db/ident-track",1923222506),cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__4131__auto__ = ident_track;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
return cljs.core.PersistentHashSet.EMPTY;
}
})(),v),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("com.wsscode.pathom.core","union-path","com.wsscode.pathom.core/union-path",-2083478095),cljs.core.constantly(cljs.core.first(p1__48930_SHARP_))], 0)),new cljs.core.Keyword("com.wsscode.pathom.core","path","com.wsscode.pathom.core/path",-1532419661),cljs.core.conj,p2__48934_SHARP_));
}
} else {
return com.wsscode.pathom.core.join.cljs$core$IFn$_invoke$arity$2(p1__48930_SHARP_,env);
}
});})(vec__48948,_,v,temp__5718__auto__,entity,map__48940,map__48940__$1,env,ast,query,refs,ident_track))
...
var vec__48984 = c;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48984,(0),null);
var sort__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48984,(1),null);
return cljs.core.vec((function (){var G__48990 = type;
...
break;
case "directed":
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(sort__$1),(function (){var G__48998 = new cljs.core.Keyword(null,"direction","direction",-633359395).cljs$core$IFn$_invoke$arity$1(sort__$1);
return (com.wsscode.pathom.map_db.direction_compare.cljs$core$IFn$_invoke$arity$1 ? com.wsscode.pathom.map_db.direction_compare.cljs$core$IFn$_invoke$arity$1(G__48998) : com.wsscode.pathom.map_db.direction_compare.call(null,G__48998));
})(),items);

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48990__$1)].join('')));
...
var G__49058 = (reader.cljs$core$IFn$_invoke$arity$1 ? reader.cljs$core$IFn$_invoke$arity$1(env) : reader.call(null,env));
if(cljs.core.truth_(sort)){
return com.wsscode.pathom.map_db.sort_results(sort,G__49058);
} else {
return G__49058;
}
});
...
return (function (p__49080,tx){
var map__49082 = p__49080;
var map__49082__$1 = (((((!((map__49082 == null))))?(((((map__49082.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49082.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__49082):map__49082);
var env = map__49082__$1;
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49082__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var env_SINGLEQUOTE_ = (function (){var G__49090 = env;
if(cljs.core.truth_(state)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__49090,new cljs.core.Keyword("com.wsscode.pathom.core","entity","com.wsscode.pathom.core/entity",884706031),cljs.core.deref(state),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("com.wsscode.pathom.map-db","refs","com.wsscode.pathom.map-db/refs",1197152641),cljs.core.deref(state)], 0));
} else {
return G__49090;
}
})();
...
var G__49103 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("com.wsscode.pathom.core","entity","com.wsscode.pathom.core/entity",884706031),data,new cljs.core.Keyword("com.wsscode.pathom.map-db","refs","com.wsscode.pathom.map-db/refs",1197152641),refs], null);
var G__49104 = com.wsscode.pathom.core.remove_query_wildcard(query);
return (com.wsscode.pathom.map_db.parser.cljs$core$IFn$_invoke$arity$2 ? com.wsscode.pathom.map_db.parser.cljs$core$IFn$_invoke$arity$2(G__49103,G__49104) : com.wsscode.pathom.map_db.parser.call(null,G__49103,G__49104));
});
if(com.wsscode.pathom.misc.INCLUDE_SPECS){
