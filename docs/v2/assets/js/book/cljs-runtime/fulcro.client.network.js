...
return xhrio.send(url,verb,body,(function (){var G__51051 = headers;
if((G__51051 == null)){
return null;
} else {
return cljs.core.clj__GT_js(G__51051);
}
})());
});
...
var current_phase = (function (){var G__51087 = progress;
var G__51087__$1 = (((G__51087 == null))?null:new cljs.core.Keyword("fulcro.client.network","progress","fulcro.client.network/progress",2047285121).cljs$core$IFn$_invoke$arity$1(G__51087));
if((G__51087__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"progress-phase","progress-phase",186626618).cljs$core$IFn$_invoke$arity$1(G__51087__$1);
}
})();
var map__51083 = (function (){var G__51096 = progress;
var G__51096__$1 = (((G__51096 == null))?null:new cljs.core.Keyword("fulcro.client.network","progress","fulcro.client.network/progress",2047285121).cljs$core$IFn$_invoke$arity$1(G__51096));
var G__51096__$2 = (((G__51096__$1 == null))?null:new cljs.core.Keyword(null,"progress-event","progress-event",1690048087).cljs$core$IFn$_invoke$arity$1(G__51096__$1));
if((G__51096__$2 == null)){
return null;
} else {
return fulcro.client.network.xhrio_progress(G__51096__$2);
}
})();
...
var e__48920__auto___51828 = e51141;
fulcro.logging._log.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"file","file",-1269645878),"fulcro.client.network",new cljs.core.Keyword(null,"line","line",212345235),91], null),new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Log statement failed (arguments did not evaluate).",e__48920__auto___51828], 0));
} else {
throw e51141;
...
var request = map__51182__$1;
var headers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51182__$1,new cljs.core.Keyword(null,"headers","headers",-835030129));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51182__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
...
var G__51185 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([request,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"body","body",-2049205669),body__$1,new cljs.core.Keyword(null,"headers","headers",-835030129),headers__$1,new cljs.core.Keyword(null,"method","method",55703592),new cljs.core.Keyword(null,"post","post",269697687)], null)], 0));
return (handler.cljs$core$IFn$_invoke$arity$1 ? handler.cljs$core$IFn$_invoke$arity$1(G__51185) : handler.call(null,G__51185));
});
;})(writer))
});
...
var G__51191 = cljs.core.update.cljs$core$IFn$_invoke$arity$5(request,new cljs.core.Keyword(null,"headers","headers",-835030129),cljs.core.assoc,"X-CSRF-Token",csrf_token);
return (handler.cljs$core$IFn$_invoke$arity$1 ? handler.cljs$core$IFn$_invoke$arity$1(G__51191) : handler.call(null,G__51191));
});
});
...
return (function fulcro$client$network$fulcro_response_handler(p__51200){
...
var response = map__51201__$1;
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51201__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var G__51204 = (function (){try{var new_body = ((clojure.string.blank_QMARK_(body))?cljs.core.PersistentArrayMap.EMPTY:cognitect.transit.read(reader,body));
...
return response__$1;
}catch (e51205){if((e51205 instanceof Object)){
var e = e51205;
...
var e__48920__auto___51854 = e51207;
fulcro.logging._log.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"file","file",-1269645878),"fulcro.client.network",new cljs.core.Keyword(null,"line","line",212345235),173], null),new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Log statement failed (arguments did not evaluate).",e__48920__auto___51854], 0));
} else {
throw e51207;
...
return (handler.cljs$core$IFn$_invoke$arity$1 ? handler.cljs$core$IFn$_invoke$arity$1(G__51204) : handler.call(null,G__51204));
});
...
cljs.spec.alpha.def_impl(new cljs.core.Keyword("fulcro.client.network","response","fulcro.client.network/response",-371044118),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","keys","cljs.spec.alpha/keys",1109346032,null),new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("fulcro.client.network","transaction","fulcro.client.network/transaction",258027239),new cljs.core.Keyword("fulcro.client.network","outgoing-request","fulcro.client.network/outgoing-request",1237007322),new cljs.core.Keyword("fulcro.client.network","body","fulcro.client.network/body",-596470011),new cljs.core.Keyword("fulcro.client.network","status-code","fulcro.client.network/status-code",2073720728),new cljs.core.Keyword("fulcro.client.network","status-text","fulcro.client.network/status-text",-323175296),new cljs.core.Keyword("fulcro.client.network","error","fulcro.client.network/error",-1674240822),new cljs.core.Keyword("fulcro.client.network","error-text","fulcro.client.network/error-text",292985712)], null),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("fulcro.client.network","progress-phase","fulcro.client.network/progress-phase",1622192464),new cljs.core.Keyword("fulcro.client.network","progress-event","fulcro.client.network/progress-event",1567427949)], null)),cljs.spec.alpha.map_spec_impl(cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.Keyword(null,"gfn","gfn",791517474),new cljs.core.Keyword(null,"pred-exprs","pred-exprs",1792271395),new cljs.core.Keyword(null,"keys-pred","keys-pred",858984739),new cljs.core.Keyword(null,"opt-keys","opt-keys",1262688261),new cljs.core.Keyword(null,"req-specs","req-specs",553962313),new cljs.core.Keyword(null,"req","req",-326448303),new cljs.core.Keyword(null,"req-keys","req-keys",514319221),new cljs.core.Keyword(null,"opt-specs","opt-specs",-384905450),new cljs.core.Keyword(null,"pred-forms","pred-forms",172611832),new cljs.core.Keyword(null,"opt","opt",-794706369)],[new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("fulcro.client.network","transaction","fulcro.client.network/transaction",258027239),new cljs.core.Keyword("fulcro.client.network","outgoing-request","fulcro.client.network/outgoing-request",1237007322),new cljs.core.Keyword("fulcro.client.network","body","fulcro.client.network/body",-596470011),new cljs.core.Keyword("fulcro.client.network","status-code","fulcro.client.network/status-code",2073720728),new cljs.core.Keyword("fulcro.client.network","status-text","fulcro.client.network/status-text",-323175296),new cljs.core.Keyword("fulcro.client.network","error","fulcro.client.network/error",-1674240822),new cljs.core.Keyword("fulcro.client.network","error-text","fulcro.client.network/error-text",292985712)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("fulcro.client.network","progress-phase","fulcro.client.network/progress-phase",1622192464),new cljs.core.Keyword("fulcro.client.network","progress-event","fulcro.client.network/progress-event",1567427949)], null),null,new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (G__51274){
return cljs.core.map_QMARK_(G__51274);
}),(function (G__51274){
return cljs.core.contains_QMARK_(G__51274,new cljs.core.Keyword(null,"transaction","transaction",1777321997));
}),(function (G__51274){
return cljs.core.contains_QMARK_(G__51274,new cljs.core.Keyword(null,"outgoing-request","outgoing-request",256391368));
}),(function (G__51274){
return cljs.core.contains_QMARK_(G__51274,new cljs.core.Keyword(null,"body","body",-2049205669));
}),(function (G__51274){
return cljs.core.contains_QMARK_(G__51274,new cljs.core.Keyword(null,"status-code","status-code",-1060410130));
}),(function (G__51274){
return cljs.core.contains_QMARK_(G__51274,new cljs.core.Keyword(null,"status-text","status-text",-1834235478));
}),(function (G__51274){
return cljs.core.contains_QMARK_(G__51274,new cljs.core.Keyword(null,"error","error",-978969032));
}),(function (G__51274){
return cljs.core.contains_QMARK_(G__51274,new cljs.core.Keyword(null,"error-text","error-text",2021893718));
})], null),(function (G__51274){
return ((cljs.core.map_QMARK_(G__51274)) && (cljs.core.contains_QMARK_(G__51274,new cljs.core.Keyword(null,"transaction","transaction",1777321997))) && (cljs.core.contains_QMARK_(G__51274,new cljs.core.Keyword(null,"outgoing-request","outgoing-request",256391368))) && (cljs.core.contains_QMARK_(G__51274,new cljs.core.Keyword(null,"body","body",-2049205669))) && (cljs.core.contains_QMARK_(G__51274,new cljs.core.Keyword(null,"status-code","status-code",-1060410130))) && (cljs.core.contains_QMARK_(G__51274,new cljs.core.Keyword(null,"status-text","status-text",-1834235478))) && (cljs.core.contains_QMARK_(G__51274,new cljs.core.Keyword(null,"error","error",-978969032))) && (cljs.core.contains_QMARK_(G__51274,new cljs.core.Keyword(null,"error-text","error-text",2021893718))));
...
cljs.spec.alpha.def_impl(new cljs.core.Keyword("fulcro.client.network","active-requests","fulcro.client.network/active-requests",-1155258669),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","and","cljs.spec.alpha/and",-2060279705,null),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-752876845,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__51325#","p1__51325#",1402640638,null)], null),cljs.core.list(new cljs.core.Symbol("cljs.core","map?","cljs.core/map?",-1390345523,null),cljs.core.list(new cljs.core.Symbol("cljs.core","deref","cljs.core/deref",1901963335,null),new cljs.core.Symbol(null,"p1__51325#","p1__51325#",1402640638,null)))),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-752876845,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__51326#","p1__51326#",-524259045,null)], null),cljs.core.list(new cljs.core.Symbol("cljs.core","every?","cljs.core/every?",1416822717,null),new cljs.core.Symbol("cljs.core","set?","cljs.core/set?",-1176684971,null),cljs.core.list(new cljs.core.Symbol("cljs.core","vals","cljs.core/vals",1473678353,null),cljs.core.list(new cljs.core.Symbol("cljs.core","deref","cljs.core/deref",1901963335,null),new cljs.core.Symbol(null,"p1__51326#","p1__51326#",-524259045,null)))))),cljs.spec.alpha.and_spec_impl(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.list(new cljs.core.Symbol("cljs.core","fn","cljs.core/fn",-1065745098,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"%","%",-950237169,null)], null),cljs.core.list(new cljs.core.Symbol("cljs.core","map?","cljs.core/map?",-1390345523,null),cljs.core.list(new cljs.core.Symbol("cljs.core","deref","cljs.core/deref",1901963335,null),new cljs.core.Symbol(null,"%","%",-950237169,null)))),cljs.core.list(new cljs.core.Symbol("cljs.core","fn","cljs.core/fn",-1065745098,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"%","%",-950237169,null)], null),cljs.core.list(new cljs.core.Symbol("cljs.core","every?","cljs.core/every?",1416822717,null),new cljs.core.Symbol("cljs.core","set?","cljs.core/set?",-1176684971,null),cljs.core.list(new cljs.core.Symbol("cljs.core","vals","cljs.core/vals",1473678353,null),cljs.core.list(new cljs.core.Symbol("cljs.core","deref","cljs.core/deref",1901963335,null),new cljs.core.Symbol(null,"%","%",-950237169,null)))))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__51325_SHARP_){
return cljs.core.map_QMARK_(cljs.core.deref(p1__51325_SHARP_));
}),(function (p1__51326_SHARP_){
return cljs.core.every_QMARK_(cljs.core.set_QMARK_,cljs.core.vals(cljs.core.deref(p1__51326_SHARP_)));
})], null),null));
 ...
 */
fulcro.client.network.was_network_error_QMARK_ = (function fulcro$client$network$was_network_error_QMARK_(p__51335){
...
var status_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51336__$1,new cljs.core.Keyword(null,"status-code","status-code",-1060410130));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51336__$1,new cljs.core.Keyword(null,"error","error",-978969032));
...
if(cljs.core.every_QMARK_((function (p1__51345_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(xhrio,p1__51345_SHARP_);
...
}catch (e51353){if((e51353 instanceof Error)){
var e__48920__auto___51917 = e51353;
fulcro.logging._log.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"file","file",-1269645878),"fulcro.client.network",new cljs.core.Keyword(null,"line","line",212345235),234], null),new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Log statement failed (arguments did not evaluate).",e__48920__auto___51917], 0));
} else {
throw e51353;
...
return (function (evt){
var map__51379 = (get_response_fn.cljs$core$IFn$_invoke$arity$0 ? get_response_fn.cljs$core$IFn$_invoke$arity$0() : get_response_fn.call(null));
...
var r = map__51379__$1;
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51379__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var middleware_exception = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51379__$1,new cljs.core.Keyword(null,"middleware-exception","middleware-exception",1033843204));
...
var e__48920__auto___51943 = e51382;
fulcro.logging._log.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"file","file",-1269645878),"fulcro.client.network",new cljs.core.Keyword(null,"line","line",212345235),271], null),new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Log statement failed (arguments did not evaluate).",e__48920__auto___51943], 0));
} else {
throw e51382;
...
var G__51387 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"progress-phase","progress-phase",186626618),phase,new cljs.core.Keyword(null,"progress-event","progress-event",1690048087),evt], null),(get_response_fn.cljs$core$IFn$_invoke$arity$0 ? get_response_fn.cljs$core$IFn$_invoke$arity$0() : get_response_fn.call(null))], 0));
return (raw_update_fn.cljs$core$IFn$_invoke$arity$1 ? raw_update_fn.cljs$core$IFn$_invoke$arity$1(G__51387) : raw_update_fn.call(null,G__51387));
} else {
return null;
}
});
...
fulcro.client.network.FulcroHTTPRemote.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k51409,else__4388__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k51409,else__4388__auto__);
...
return (function (ret__4407__auto__,p__51424){
var vec__51425 = p__51424;
var k__4408__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51425,(0),null);
var v__4409__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51425,(1),null);
...
fulcro.client.network.FulcroHTTPRemote.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__51408){
var self__ = this;
var G__51408__$1 = this;
return (new cljs.core.RecordIter((0),G__51408__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"url","url",276297046),new cljs.core.Keyword(null,"request-middleware","request-middleware",589056817),new cljs.core.Keyword(null,"response-middleware","response-middleware",-1502080044),new cljs.core.Keyword(null,"active-requests","active-requests",1354177961),new cljs.core.Keyword(null,"serial?","serial?",1994367781)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
fulcro.client.network.FulcroHTTPRemote.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this51410,other51411){
var self__ = this;
var this51410__$1 = this;
return (((!((other51411 == null)))) && ((this51410__$1.constructor === other51411.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51410__$1.url,other51411.url)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51410__$1.request_middleware,other51411.request_middleware)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51410__$1.response_middleware,other51411.response_middleware)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51410__$1.active_requests,other51411.active_requests)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51410__$1.serial_QMARK_,other51411.serial_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51410__$1.__extmap,other51411.__extmap)));
});

fulcro.client.network.FulcroHTTPRemote.prototype.fulcro$client$network$FulcroRemoteI$ = cljs.core.PROTOCOL_SENTINEL;

fulcro.client.network.FulcroHTTPRemote.prototype.fulcro$client$network$FulcroRemoteI$transmit$arity$2 = (function (this$,p__51447){
var self__ = this;
...
var raw_request = map__51449__$1;
var edn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51449__$1,new cljs.core.Keyword("fulcro.client.network","edn","fulcro.client.network/edn",-1239708957));
var abort_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51449__$1,new cljs.core.Keyword("fulcro.client.network","abort-id","fulcro.client.network/abort-id",-22430267));
var ok_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51449__$1,new cljs.core.Keyword("fulcro.client.network","ok-handler","fulcro.client.network/ok-handler",-107274727));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51449__$1,new cljs.core.Keyword("fulcro.client.network","error-handler","fulcro.client.network/error-handler",-607171226));
var progress_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51449__$1,new cljs.core.Keyword("fulcro.client.network","progress-handler","fulcro.client.network/progress-handler",1886593355));
var this$__$1 = this;
var temp__5718__auto__ = (function (){try{var G__51464 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"headers","headers",-835030129),cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"body","body",-2049205669),edn,new cljs.core.Keyword(null,"url","url",276297046),self__.url,new cljs.core.Keyword(null,"method","method",55703592),new cljs.core.Keyword(null,"post","post",269697687)], null);
return (self__.request_middleware.cljs$core$IFn$_invoke$arity$1 ? self__.request_middleware.cljs$core$IFn$_invoke$arity$1(G__51464) : self__.request_middleware.call(null,G__51464));
}catch (e51457){var e = e51457;
...
var e__48920__auto___51985 = e51458;
fulcro.logging._log.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"file","file",-1269645878),"fulcro.client.network",new cljs.core.Keyword(null,"line","line",212345235),313], null),new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Log statement failed (arguments did not evaluate).",e__48920__auto___51985], 0));
} else {
throw e51458;
...
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51466__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var headers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51466__$1,new cljs.core.Keyword(null,"headers","headers",-835030129));
var url__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51466__$1,new cljs.core.Keyword(null,"url","url",276297046));
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51466__$1,new cljs.core.Keyword(null,"method","method",55703592));
...
var extract_response = ((function (xhrio,map__51466,map__51466__$1,body,headers,url__$1,method,http_verb,real_request,temp__5718__auto__,this$__$1,map__51449,map__51449__$1,raw_request,edn,abort_id,ok_handler,error_handler,progress_handler){
return (function (){
return fulcro.client.network.extract_response(body,real_request,xhrio);
});})(xhrio,map__51466,map__51466__$1,body,headers,url__$1,method,http_verb,real_request,temp__5718__auto__,this$__$1,map__51449,map__51449__$1,raw_request,edn,abort_id,ok_handler,error_handler,progress_handler))
;
...
var with_cleanup = ((function (xhrio,map__51466,map__51466__$1,body,headers,url__$1,method,http_verb,extract_response,extract_response_mw,gc_network_resources,progress_routine,ok_routine,error_routine,real_request,temp__5718__auto__,this$__$1,map__51449,map__51449__$1,raw_request,edn,abort_id,ok_handler,error_handler,progress_handler){
return (function (f){
return ((function (xhrio,map__51466,map__51466__$1,body,headers,url__$1,method,http_verb,extract_response,extract_response_mw,gc_network_resources,progress_routine,ok_routine,error_routine,real_request,temp__5718__auto__,this$__$1,map__51449,map__51449__$1,raw_request,edn,abort_id,ok_handler,error_handler,progress_handler){
return (function (evt){
...
goog.events.listen(xhrio,goog.net.EventType.DOWNLOAD_PROGRESS,((function (xhrio,map__51466,map__51466__$1,body,headers,url__$1,method,http_verb,extract_response,extract_response_mw,gc_network_resources,progress_routine,ok_routine,error_routine,with_cleanup,real_request,temp__5718__auto__,this$__$1,map__51449,map__51449__$1,raw_request,edn,abort_id,ok_handler,error_handler,progress_handler){
return (function (p1__51404_SHARP_){
return progress_routine(new cljs.core.Keyword(null,"receiving","receiving",829203724),p1__51404_SHARP_);
});})(xhrio,map__51466,map__51466__$1,body,headers,url__$1,method,http_verb,extract_response,extract_response_mw,gc_network_resources,progress_routine,ok_routine,error_routine,with_cleanup,real_request,temp__5718__auto__,this$__$1,map__51449,map__51449__$1,raw_request,edn,abort_id,ok_handler,error_handler,progress_handler))
);

goog.events.listen(xhrio,goog.net.EventType.UPLOAD_PROGRESS,((function (xhrio,map__51466,map__51466__$1,body,headers,url__$1,method,http_verb,extract_response,extract_response_mw,gc_network_resources,progress_routine,ok_routine,error_routine,with_cleanup,real_request,temp__5718__auto__,this$__$1,map__51449,map__51449__$1,raw_request,edn,abort_id,ok_handler,error_handler,progress_handler){
return (function (p1__51405_SHARP_){
return progress_routine(new cljs.core.Keyword(null,"sending","sending",-1806704862),p1__51405_SHARP_);
});})(xhrio,map__51466,map__51466__$1,body,headers,url__$1,method,http_verb,extract_response,extract_response_mw,gc_network_resources,progress_routine,ok_routine,error_routine,with_cleanup,real_request,temp__5718__auto__,this$__$1,map__51449,map__51449__$1,raw_request,edn,abort_id,ok_handler,error_handler,progress_handler))
);
} else {
}
...
goog.events.listen(xhrio,goog.net.EventType.ABORT,with_cleanup(((function (xhrio,map__51466,map__51466__$1,body,headers,url__$1,method,http_verb,extract_response,extract_response_mw,gc_network_resources,progress_routine,ok_routine,error_routine,with_cleanup,real_request,temp__5718__auto__,this$__$1,map__51449,map__51449__$1,raw_request,edn,abort_id,ok_handler,error_handler,progress_handler){
return (function (){
var G__51476 = cljs.core.PersistentArrayMap.EMPTY;
return (ok_handler.cljs$core$IFn$_invoke$arity$1 ? ok_handler.cljs$core$IFn$_invoke$arity$1(G__51476) : ok_handler.call(null,G__51476));
});})(xhrio,map__51466,map__51466__$1,body,headers,url__$1,method,http_verb,extract_response,extract_response_mw,gc_network_resources,progress_routine,ok_routine,error_routine,with_cleanup,real_request,temp__5718__auto__,this$__$1,map__51449,map__51449__$1,raw_request,edn,abort_id,ok_handler,error_handler,progress_handler))
));
...
var G__51477 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"error","error",-978969032),new cljs.core.Keyword(null,"abort","abort",521193198),new cljs.core.Keyword(null,"error-text","error-text",2021893718),"Transmission was aborted because the request middleware threw an exception"], null);
return (error_handler.cljs$core$IFn$_invoke$arity$1 ? error_handler.cljs$core$IFn$_invoke$arity$1(G__51477) : error_handler.call(null,G__51477));
}
});
...
var seq__51478 = cljs.core.seq(xhrios);
var chunk__51479 = null;
var count__51480 = (0);
var i__51481 = (0);
while(true){
if((i__51481 < count__51480)){
var xhrio = chunk__51479.cljs$core$IIndexed$_nth$arity$2(null,i__51481);
fulcro.client.network.xhrio_abort(xhrio);


var G__52005 = seq__51478;
var G__52006 = chunk__51479;
var G__52007 = count__51480;
var G__52008 = (i__51481 + (1));
seq__51478 = G__52005;
chunk__51479 = G__52006;
count__51480 = G__52007;
i__51481 = G__52008;
continue;
} else {
var temp__5720__auto____$1 = cljs.core.seq(seq__51478);
if(temp__5720__auto____$1){
var seq__51478__$1 = temp__5720__auto____$1;
if(cljs.core.chunked_seq_QMARK_(seq__51478__$1)){
var c__4550__auto__ = cljs.core.chunk_first(seq__51478__$1);
var G__52010 = cljs.core.chunk_rest(seq__51478__$1);
var G__52011 = c__4550__auto__;
var G__52012 = cljs.core.count(c__4550__auto__);
var G__52013 = (0);
seq__51478 = G__52010;
chunk__51479 = G__52011;
count__51480 = G__52012;
i__51481 = G__52013;
continue;
} else {
var xhrio = cljs.core.first(seq__51478__$1);
fulcro.client.network.xhrio_abort(xhrio);


var G__52016 = cljs.core.next(seq__51478__$1);
var G__52017 = null;
var G__52018 = (0);
var G__52019 = (0);
seq__51478 = G__52016;
chunk__51479 = G__52017;
count__51480 = G__52018;
i__51481 = G__52019;
continue;
}
} else {
...
fulcro.client.network.FulcroHTTPRemote.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__51408){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__51486 = cljs.core.keyword_identical_QMARK_;
var expr__51487 = k__4393__auto__;
if(cljs.core.truth_((pred__51486.cljs$core$IFn$_invoke$arity$2 ? pred__51486.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"url","url",276297046),expr__51487) : pred__51486.call(null,new cljs.core.Keyword(null,"url","url",276297046),expr__51487)))){
return (new fulcro.client.network.FulcroHTTPRemote(G__51408,self__.request_middleware,self__.response_middleware,self__.active_requests,self__.serial_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51486.cljs$core$IFn$_invoke$arity$2 ? pred__51486.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"request-middleware","request-middleware",589056817),expr__51487) : pred__51486.call(null,new cljs.core.Keyword(null,"request-middleware","request-middleware",589056817),expr__51487)))){
return (new fulcro.client.network.FulcroHTTPRemote(self__.url,G__51408,self__.response_middleware,self__.active_requests,self__.serial_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51486.cljs$core$IFn$_invoke$arity$2 ? pred__51486.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"response-middleware","response-middleware",-1502080044),expr__51487) : pred__51486.call(null,new cljs.core.Keyword(null,"response-middleware","response-middleware",-1502080044),expr__51487)))){
return (new fulcro.client.network.FulcroHTTPRemote(self__.url,self__.request_middleware,G__51408,self__.active_requests,self__.serial_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51486.cljs$core$IFn$_invoke$arity$2 ? pred__51486.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"active-requests","active-requests",1354177961),expr__51487) : pred__51486.call(null,new cljs.core.Keyword(null,"active-requests","active-requests",1354177961),expr__51487)))){
return (new fulcro.client.network.FulcroHTTPRemote(self__.url,self__.request_middleware,self__.response_middleware,G__51408,self__.serial_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51486.cljs$core$IFn$_invoke$arity$2 ? pred__51486.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"serial?","serial?",1994367781),expr__51487) : pred__51486.call(null,new cljs.core.Keyword(null,"serial?","serial?",1994367781),expr__51487)))){
return (new fulcro.client.network.FulcroHTTPRemote(self__.url,self__.request_middleware,self__.response_middleware,self__.active_requests,G__51408,self__.__meta,self__.__extmap,null));
} else {
return (new fulcro.client.network.FulcroHTTPRemote(self__.url,self__.request_middleware,self__.response_middleware,self__.active_requests,self__.serial_QMARK_,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4393__auto__,G__51408),null));
}
}
}
}
...
fulcro.client.network.FulcroHTTPRemote.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__51408){
var self__ = this;
var this__4384__auto____$1 = this;
return (new fulcro.client.network.FulcroHTTPRemote(self__.url,self__.request_middleware,self__.response_middleware,self__.active_requests,self__.serial_QMARK_,G__51408,self__.__extmap,self__.__hash));
});
 ...
 */
fulcro.client.network.fulcro_http_remote = (function fulcro$client$network$fulcro_http_remote(p__51566){
...
var options = map__51567__$1;
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51567__$1,new cljs.core.Keyword(null,"url","url",276297046),"/api");
var request_middleware = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51567__$1,new cljs.core.Keyword(null,"request-middleware","request-middleware",589056817),fulcro.client.network.wrap_fulcro_request.cljs$core$IFn$_invoke$arity$0());
var response_middleware = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__51567__$1,new cljs.core.Keyword(null,"response-middleware","response-middleware",-1502080044),fulcro.client.network.wrap_fulcro_response.cljs$core$IFn$_invoke$arity$0());
var serial_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51567__$1,new cljs.core.Keyword(null,"serial?","serial?",1994367781));
...
fulcro.client.network.Network.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k51617,else__4388__auto__){
var self__ = this;
var this__4387__auto____$1 = this;
var G__51630 = k51617;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k51617,else__4388__auto__);
...
var this__4404__auto____$1 = this;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (this__4404__auto____$1){
return (function (ret__4407__auto__,p__51639){
var vec__51640 = p__51639;
var k__4408__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51640,(0),null);
var v__4409__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51640,(1),null);
return (f__4405__auto__.cljs$core$IFn$_invoke$arity$3 ? f__4405__auto__.cljs$core$IFn$_invoke$arity$3(ret__4407__auto__,k__4408__auto__,v__4409__auto__) : f__4405__auto__.call(null,ret__4407__auto__,k__4408__auto__,v__4409__auto__));
});})(this__4404__auto____$1))
,init__4406__auto__,this__4404__auto____$1);
});
...
fulcro.client.network.Network.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__51616){
var self__ = this;
var G__51616__$1 = this;
return (new cljs.core.RecordIter((0),G__51616__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"url","url",276297046),new cljs.core.Keyword(null,"request-transform","request-transform",170337297),new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631),new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var G__51651 = (function (){var or__4131__auto__ = query_response;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
return (valid_data_callback.cljs$core$IFn$_invoke$arity$1 ? valid_data_callback.cljs$core$IFn$_invoke$arity$1(G__51651) : valid_data_callback.call(null,G__51651));
} else {
return null;
}
...
}catch (e51654){if((e51654 instanceof Error)){
var e__48920__auto___52094 = e51654;
fulcro.logging._log.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"file","file",-1269645878),"fulcro.client.network",new cljs.core.Keyword(null,"line","line",212345235),440], null),new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Log statement failed (arguments did not evaluate).",e__48920__auto___52094], 0));
} else {
throw e51654;
...
var fexpr__51656 = cljs.core.deref(self__.global_error_callback);
return (fexpr__51656.cljs$core$IFn$_invoke$arity$2 ? fexpr__51656.cljs$core$IFn$_invoke$arity$2(status,error) : fexpr__51656.call(null,status,error));
} else {
return null;
}
});})(status,this$__$1))
...
fulcro.client.network.Network.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this51618,other51619){
var self__ = this;
var this51618__$1 = this;
return (((!((other51619 == null)))) && ((this51618__$1.constructor === other51619.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51618__$1.url,other51619.url)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51618__$1.request_transform,other51619.request_transform)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51618__$1.global_error_callback,other51619.global_error_callback)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51618__$1.complete_app,other51619.complete_app)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51618__$1.transit_handlers,other51619.transit_handlers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51618__$1.__extmap,other51619.__extmap)));
});
...
var map__51673 = (function (){var G__51674 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"body","body",-2049205669),edn,new cljs.core.Keyword(null,"headers","headers",-835030129),headers], null);
if(cljs.core.truth_(self__.request_transform)){
return (self__.request_transform.cljs$core$IFn$_invoke$arity$1 ? self__.request_transform.cljs$core$IFn$_invoke$arity$1(G__51674) : self__.request_transform.call(null,G__51674));
} else {
return G__51674;
}
})();
var map__51673__$1 = (((((!((map__51673 == null))))?(((((map__51673.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__51673.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__51673):map__51673);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51673__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var headers__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51673__$1,new cljs.core.Keyword(null,"headers","headers",-835030129));
...
goog.events.listen(xhrio,goog.net.EventType.SUCCESS,((function (xhrio,handlers,headers,map__51673,map__51673__$1,body,headers__$1,post_data,headers__$2,this$__$1){
return (function (){
return this$__$1.fulcro$client$network$IXhrIOCallbacks$response_ok$arity$3(null,xhrio,ok);
});})(xhrio,handlers,headers,map__51673,map__51673__$1,body,headers__$1,post_data,headers__$2,this$__$1))
);

goog.events.listen(xhrio,goog.net.EventType.ERROR,((function (xhrio,handlers,headers,map__51673,map__51673__$1,body,headers__$1,post_data,headers__$2,this$__$1){
return (function (){
...
fulcro.client.network.Network.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__51616){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__51681 = cljs.core.keyword_identical_QMARK_;
var expr__51682 = k__4393__auto__;
if(cljs.core.truth_((pred__51681.cljs$core$IFn$_invoke$arity$2 ? pred__51681.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"url","url",276297046),expr__51682) : pred__51681.call(null,new cljs.core.Keyword(null,"url","url",276297046),expr__51682)))){
return (new fulcro.client.network.Network(G__51616,self__.request_transform,self__.global_error_callback,self__.complete_app,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51681.cljs$core$IFn$_invoke$arity$2 ? pred__51681.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"request-transform","request-transform",170337297),expr__51682) : pred__51681.call(null,new cljs.core.Keyword(null,"request-transform","request-transform",170337297),expr__51682)))){
return (new fulcro.client.network.Network(self__.url,G__51616,self__.global_error_callback,self__.complete_app,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51681.cljs$core$IFn$_invoke$arity$2 ? pred__51681.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631),expr__51682) : pred__51681.call(null,new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631),expr__51682)))){
return (new fulcro.client.network.Network(self__.url,self__.request_transform,G__51616,self__.complete_app,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51681.cljs$core$IFn$_invoke$arity$2 ? pred__51681.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),expr__51682) : pred__51681.call(null,new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),expr__51682)))){
return (new fulcro.client.network.Network(self__.url,self__.request_transform,self__.global_error_callback,G__51616,self__.transit_handlers,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__51681.cljs$core$IFn$_invoke$arity$2 ? pred__51681.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791),expr__51682) : pred__51681.call(null,new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791),expr__51682)))){
return (new fulcro.client.network.Network(self__.url,self__.request_transform,self__.global_error_callback,self__.complete_app,G__51616,self__.__meta,self__.__extmap,null));
} else {
return (new fulcro.client.network.Network(self__.url,self__.request_transform,self__.global_error_callback,self__.complete_app,self__.transit_handlers,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4393__auto__,G__51616),null));
}
}
}
}
...
fulcro.client.network.Network.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__51616){
var self__ = this;
var this__4384__auto____$1 = this;
return (new fulcro.client.network.Network(self__.url,self__.request_transform,self__.global_error_callback,self__.complete_app,self__.transit_handlers,G__51616,self__.__extmap,self__.__hash));
});
 ...
 */
fulcro.client.network.map__GT_Network = (function fulcro$client$network$map__GT_Network(G__51620){
var extmap__4424__auto__ = (function (){var G__51698 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__51620,new cljs.core.Keyword(null,"url","url",276297046),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"request-transform","request-transform",170337297),new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631),new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791)], 0));
if(cljs.core.record_QMARK_(G__51620)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__51698);
} else {
return G__51698;
}
})();
return (new fulcro.client.network.Network(new cljs.core.Keyword(null,"url","url",276297046).cljs$core$IFn$_invoke$arity$1(G__51620),new cljs.core.Keyword(null,"request-transform","request-transform",170337297).cljs$core$IFn$_invoke$arity$1(G__51620),new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631).cljs$core$IFn$_invoke$arity$1(G__51620),new cljs.core.Keyword(null,"complete-app","complete-app",1317441339).cljs$core$IFn$_invoke$arity$1(G__51620),new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791).cljs$core$IFn$_invoke$arity$1(G__51620),null,cljs.core.not_empty(extmap__4424__auto__),null));
});
...
var i__4731__auto___52130 = (0);
while(true){
if((i__4731__auto___52130 < len__4730__auto___52127)){
args__4736__auto__.push((arguments[i__4731__auto___52130]));

var G__52131 = (i__4731__auto___52130 + (1));
i__4731__auto___52130 = G__52131;
continue;
} else {
}
break;
...
fulcro.client.network.make_fulcro_network.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__51709){
var map__51711 = p__51709;
...
var request_transform = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51711__$1,new cljs.core.Keyword(null,"request-transform","request-transform",170337297));
var global_error_callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51711__$1,new cljs.core.Keyword(null,"global-error-callback","global-error-callback",901427631));
var transit_handlers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51711__$1,new cljs.core.Keyword(null,"transit-handlers","transit-handlers",-1206080791));
...
/** @this {Function} */
fulcro.client.network.make_fulcro_network.cljs$lang$applyTo = (function (seq51703){
var G__51704 = cljs.core.first(seq51703);
var seq51703__$1 = cljs.core.next(seq51703);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51704,seq51703__$1);
});
...
fulcro.client.network.MockNetwork.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k51719,else__4388__auto__){
var self__ = this;
var this__4387__auto____$1 = this;
var G__51729 = k51719;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k51719,else__4388__auto__);
...
var this__4404__auto____$1 = this;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (this__4404__auto____$1){
return (function (ret__4407__auto__,p__51737){
var vec__51738 = p__51737;
var k__4408__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51738,(0),null);
var v__4409__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51738,(1),null);
return (f__4405__auto__.cljs$core$IFn$_invoke$arity$3 ? f__4405__auto__.cljs$core$IFn$_invoke$arity$3(ret__4407__auto__,k__4408__auto__,v__4409__auto__) : f__4405__auto__.call(null,ret__4407__auto__,k__4408__auto__,v__4409__auto__));
});})(this__4404__auto____$1))
,init__4406__auto__,this__4404__auto____$1);
});
...
fulcro.client.network.MockNetwork.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__51718){
var self__ = this;
var G__51718__$1 = this;
return (new cljs.core.RecordIter((0),G__51718__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"complete-app","complete-app",1317441339)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
fulcro.client.network.MockNetwork.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this51720,other51721){
var self__ = this;
var this51720__$1 = this;
return (((!((other51721 == null)))) && ((this51720__$1.constructor === other51721.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51720__$1.complete_app,other51721.complete_app)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this51720__$1.__extmap,other51721.__extmap)));
});
...
}catch (e51761){if((e51761 instanceof Error)){
var e__48920__auto__ = e51761;
return fulcro.logging._log.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"file","file",-1269645878),"fulcro.client.network",new cljs.core.Keyword(null,"line","line",212345235),501], null),new cljs.core.Keyword(null,"info","info",-317069002),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Log statement failed (arguments did not evaluate).",e__48920__auto__], 0));
} else {
throw e51761;
...
fulcro.client.network.MockNetwork.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__51718){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__51768 = cljs.core.keyword_identical_QMARK_;
var expr__51769 = k__4393__auto__;
if(cljs.core.truth_((pred__51768.cljs$core$IFn$_invoke$arity$2 ? pred__51768.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),expr__51769) : pred__51768.call(null,new cljs.core.Keyword(null,"complete-app","complete-app",1317441339),expr__51769)))){
return (new fulcro.client.network.MockNetwork(G__51718,self__.__meta,self__.__extmap,null));
} else {
return (new fulcro.client.network.MockNetwork(self__.complete_app,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4393__auto__,G__51718),null));
}
});
...
fulcro.client.network.MockNetwork.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__51718){
var self__ = this;
var this__4384__auto____$1 = this;
return (new fulcro.client.network.MockNetwork(self__.complete_app,G__51718,self__.__extmap,self__.__hash));
});
 ...
 */
fulcro.client.network.map__GT_MockNetwork = (function fulcro$client$network$map__GT_MockNetwork(G__51724){
var extmap__4424__auto__ = (function (){var G__51783 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__51724,new cljs.core.Keyword(null,"complete-app","complete-app",1317441339));
if(cljs.core.record_QMARK_(G__51724)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__51783);
} else {
return G__51783;
}
})();
return (new fulcro.client.network.MockNetwork(new cljs.core.Keyword(null,"complete-app","complete-app",1317441339).cljs$core$IFn$_invoke$arity$1(G__51724),null,cljs.core.not_empty(extmap__4424__auto__),null));
});
