...
return (function (state_52915){
var state_val_52916 = (state_52915[(1)]);
if((state_val_52916 === (1))){
var inst_52902 = cljs.core.async.timeout((1000));
var state_52915__$1 = state_52915;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_52915__$1,(2),inst_52902);
} else {
if((state_val_52916 === (2))){
var inst_52904 = (state_52915[(2)]);
var inst_52908 = (function (){return ((function (inst_52904,state_val_52916,c__38971__auto__){
return (function (v){
...
;})(inst_52904,state_val_52916,c__38971__auto__))
})();
var inst_52909 = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(inst_52908,input);
var state_52915__$1 = (function (){var statearr_52949 = state_52915;
(statearr_52949[(7)] = inst_52904);

return statearr_52949;
})();
return cljs.core.async.impl.ioc_helpers.return_chan(state_52915__$1,inst_52909);
} else {
return null;
}
}
...
return (function() {
var com$wsscode$pathom$book$connect$batch3$slow_resolver_$_state_machine__38925__auto__ = null;
var com$wsscode$pathom$book$connect$batch3$slow_resolver_$_state_machine__38925__auto____0 = (function (){
var statearr_52955 = [null,null,null,null,null,null,null,null];
(statearr_52955[(0)] = com$wsscode$pathom$book$connect$batch3$slow_resolver_$_state_machine__38925__auto__);

(statearr_52955[(1)] = (1));

return statearr_52955;
});
var com$wsscode$pathom$book$connect$batch3$slow_resolver_$_state_machine__38925__auto____1 = (function (state_52915){
while(true){
var ret_value__38926__auto__ = (function (){try{while(true){
var result__38927__auto__ = switch__38924__auto__(state_52915);
...
}catch (e52967){if((e52967 instanceof Object)){
var ex__38928__auto__ = e52967;
var statearr_52968_53039 = state_52915;
(statearr_52968_53039[(5)] = ex__38928__auto__);


cljs.core.async.impl.ioc_helpers.process_exception(state_52915);
...
var G__53042 = state_52915;
state_52915 = G__53042;
continue;
} else {
...
com$wsscode$pathom$book$connect$batch3$slow_resolver_$_state_machine__38925__auto__ = function(state_52915){
switch(arguments.length){
case 0:
return com$wsscode$pathom$book$connect$batch3$slow_resolver_$_state_machine__38925__auto____0.call(this);
case 1:
return com$wsscode$pathom$book$connect$batch3$slow_resolver_$_state_machine__38925__auto____1.call(this,state_52915);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
com$wsscode$pathom$book$connect$batch3$slow_resolver_$_state_machine__38925__auto__.cljs$core$IFn$_invoke$arity$0 = com$wsscode$pathom$book$connect$batch3$slow_resolver_$_state_machine__38925__auto____0;
com$wsscode$pathom$book$connect$batch3$slow_resolver_$_state_machine__38925__auto__.cljs$core$IFn$_invoke$arity$1 = com$wsscode$pathom$book$connect$batch3$slow_resolver_$_state_machine__38925__auto____1;
return com$wsscode$pathom$book$connect$batch3$slow_resolver_$_state_machine__38925__auto__;
})()
;})(switch__38924__auto__,c__38971__auto__))
})();
var state__38973__auto__ = (function (){var statearr_53023 = (f__38972__auto__.cljs$core$IFn$_invoke$arity$0 ? f__38972__auto__.cljs$core$IFn$_invoke$arity$0() : f__38972__auto__.call(null));
(statearr_53023[(6)] = c__38971__auto__);
