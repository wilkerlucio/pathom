...
var o41121 = temp__5718__auto__;
var temp__5718__auto____$1 = (o41121["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o41122 = temp__5718__auto____$1;
return (o41122["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40636__auto__ = f;
return (o__40636__auto__["toString"]).call(o__40636__auto__);
} else {
return "";
}
...
try{var o__40636__auto___41570 = t;
(o__40636__auto___41570["cljs$lang$ctorPrWriter"]).call(o__40636__auto___41570,t,writer);
}catch (e41143){var __41572 = e41143;
}
...
var char_code = (function (){var o__40636__auto__ = (new String(char$));
return (o__40636__auto__["charCodeAt"]).call(o__40636__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40636__auto__ = String;
return (o__40636__auto__["fromCharCode"]).call(o__40636__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41172 = num_code;
switch (G__41172) {
case (1):
return (185);
...
var o__40636__auto__ = String;
return (o__40636__auto__["fromCharCode"]).call(o__40636__auto__,superscript_code);
});
/**
...
}catch (e41210){var _e__40679__auto__ = e41210;
return false;
}})())){
...
var vec__41213 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41213,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o41231 = temp__5718__auto__;
var temp__5718__auto____$1 = (o41231["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o41232 = temp__5718__auto____$1;
return (o41232["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___41595 = arguments.length;
var i__4731__auto___41596 = (0);
while(true){
if((i__4731__auto___41596 < len__4730__auto___41595)){
args__4736__auto__.push((arguments[i__4731__auto___41596]));

var G__41597 = (i__4731__auto___41596 + (1));
i__4731__auto___41596 = G__41597;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41239){
var vec__41240 = p__41239;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41240,(0),null);
...
var G__41598 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__41599 = cljs.core.butlast(remaining_tokens);
name_tokens = G__41598;
remaining_tokens = G__41599;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41236){
var G__41237 = cljs.core.first(seq41236);
var seq41236__$1 = cljs.core.next(seq41236);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41237,seq41236__$1);
});
...
var vec__41252 = cljs.core.split_with((function (p1__41251_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__41251_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41252,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41252,(1),null);
...
var vec__41271 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41271,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41271,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__41602 = cljs.core.rest(remaining_tokens);
var G__41603 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__41602;
name_tokens = G__41603;
continue;
} else {
...
var vec__41284 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41284,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41284,(1),null);
var vec__41287 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41287,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41287,(1),null);
var vec__41290 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41290,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41290,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41290,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41290,(3),null);
...
var vec__41305 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41305,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41305,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41305,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41305,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41305,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41305,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__41312 = temp__5718__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41312,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41312,(1),null);
var vec__41315 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41315,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41315,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41321 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41321) : devtools.munging.parse_fn_info_deep.call(null,G__41321));
})()));
}
} else {
return fn_info;
...
var G__41620 = (arity + (1));
var G__41621 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41343,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41343,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41365_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41366_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___41626 = arguments.length;
var i__4731__auto___41627 = (0);
while(true){
if((i__4731__auto___41627 < len__4730__auto___41626)){
args__4736__auto__.push((arguments[i__4731__auto___41627]));

var G__41630 = (i__4731__auto___41627 + (1));
i__4731__auto___41627 = G__41630;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41374){
var vec__41376 = p__41374;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41376,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41370){
var G__41371 = cljs.core.first(seq41370);
var seq41370__$1 = cljs.core.next(seq41370);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41371,seq41370__$1);
});
...
var G__41389 = arg;
var G__41389__$1 = (((G__41389 instanceof cljs.core.Keyword))?G__41389.fqn:null);
switch (G__41389__$1) {
...
var map__41466 = options;
var map__41466__$1 = (((((!((map__41466 == null))))?(((((map__41466.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41466.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41466):map__41466);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41466__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41466__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41466__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41466__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41467 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41467,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41467,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41467,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41467,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41467,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41467,(5),null);
...
var o__40636__auto__ = f;
return (o__40636__auto__["getBasis"]).call(o__40636__auto__);
});
/**
...
}catch (e41481){var _e__40679__auto__ = e41481;
...
var G__41665 = (obj[cljs.core.first(path)]);
var G__41666 = cljs.core.rest(path);
obj = G__41665;
path = G__41666;
continue;
} else {
...
return (function (accum,p__41512){
var vec__41513 = p__41512;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41513,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41513,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41527){
var vec__41528 = p__41527;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41528,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41528,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41528,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41548,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41548,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__41548,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__41535_SHARP_){
return (obj[cljs.core.first(p1__41535_SHARP_)]);
});})(name,sorted_matches,vec__41548,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
