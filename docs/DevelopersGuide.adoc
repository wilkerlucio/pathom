...
The core functionality should be considered low-level functionality, and most people will
be most interested in the "Connect" features, which allow you to quickly build dynamic
...
If you like to learn by seeing presentations, I did one at Clojure Days 2018, you can
check it at: https://www.youtube.com/watch?v=r3zywlNflJI.
...
By using the `::p/env` the `env-plugin` will be setup automatically.
